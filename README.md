...
The contact form uses Netlify Forms (`msd-contact`) and is ready to collect submissions after deployment. Set the production domain in `src/app/layout.tsx` if it changes from `mountainstandarddigital.com`.
