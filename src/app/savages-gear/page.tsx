...
export default function SavagesGear() {
  return <main className="savages-gear-page">
    ...
    <section className="gear-feature" aria-labelledby="last-cast-title"><div className="gear-feature-copy"><p>FEATURED / 01</p><h2 id="last-cast-title">LAST<br />CAST.</h2><span>Sticker · $5</span><a href="#collection">View Sticker <b>→</b></a></div><figure><Image src="/assets/savages-sticker-last-cast.png" alt="Last Cast Savages Fly Gear sticker artwork" fill sizes="(max-width: 800px) 100vw, 48vw" priority /></figure></section>
